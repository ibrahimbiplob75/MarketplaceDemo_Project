...
<html lang="en">
  <head>
    ...
    <title>Php Larabel- @yield('title')</title>
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href="{{('/dashboard')}}"><i class="icon ion-android-star-outline"></i> starlight</a></div>
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        <a href="{{('/home')}}" class="sl-menu-link">
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{('/category')}}" class="nav-link">ADD Category List</a></li>
          <li class="nav-item"><a href="{{('/subcategory')}}" class="nav-link">ADD Subcategory</a></li>
        ...
        <a href="#" class="sl-menu-link">
          <div class="sl-menu-item">
            ...
            <span class="menu-item-label">Products List</span>
            <i class="menu-item-arrow fa fa-angle-down"></i>
          </div><!-- menu-item -->
        </a><!-- sl-menu-link -->
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{('/products')}}" class="nav-link">Add products</a></li>
          <!-- <li class="nav-item"><a href="alerts.html" class="nav-link">Edit</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
          <li class="nav-item"><a href="{{'/product/invetory'}}" class="nav-link">Products_Color &size</a></li>
        ...
        <ul class="sl-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="{{('/login')}}" class="nav-link">Signin Page</a></li>
          <li class="nav-item"><a href="{{('/register')}}" class="nav-link">Signup Page</a></li>
        </ul>
        ...
        <nav class="nav-item">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              ...
              <img src="{{asset('dashboard_assets/uploads/user')}}/{{Auth::user()->photo}}" class="wd-32 rounded-circle" alt="">
            </a>
