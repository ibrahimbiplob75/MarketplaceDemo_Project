...
<head>
    ...
    <title>Jesco - Fashoin eCommerce Products Details</title>
    <meta name="description" content="Jesco - Fashoin eCommerce HTML Template" />
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" />

    <!-- Add site Favicon -->
    <link rel="shortcut icon" href="fronted_assets/images/favicon/favicon.ico" type="image/png">


    <link rel="stylesheet" href="{{asset('fronted_assets/css/vendor/vendor.min.css')}}" />
    <link rel="stylesheet" href="{{asset('fronted_assets/css/plugins/plugins.min.css')}}" />
    <link rel="stylesheet" href="{{asset('fronted_assets/css/style.min.css')}}">

    <!-- Main Style -->
   <link rel="stylesheet" href="{{asset('fronted_assets/css/style.css')}}" />
...
<body>
                ...
                <div class="row">
                    <div class="col-auto align-self-center">
                        <div class="header-logo">
                            <a href="index.html"><img src="{{asset('fronted_assets/images/logo/logo.png')}}" alt="Site Logo" /></a>
                        </div>
                    </div>
                                            ...
                                            <ul class="menu-banner w-100">
                                                <li>
                                                    <a class="p-0" href="shop-left-sidebar.html"><img
                                                            ...
                                                            src="fronted_assets/images/banner/7.jpg" alt=""></a>
                                                </li>
                                                <li>
                                                    <a class="p-0" href="shop-left-sidebar.html"><img
                                                            class="img-responsive w-100"
                                                            src="fronted_assets/images/banner/8.jpg" alt=""></a>
                                                </li>
                                                <li>
                                                    <a class="p-0" href="shop-left-sidebar.html"><img
                                                            class="img-responsive w-100"
                                                            src="fronted_assets/images/banner/9.jpg" alt=""></a>
                                                </li>
                                            </ul>
                                        </li>
                                    </ul>
                    ...
                    <div class="col col-lg-auto align-self-center pl-0">
                        ...
                        @auth('coustomerlogin')
                            <a href="{{('/coustomer/account')}}" class="header-action-btn login-btn" >{{Auth::guard('coustomerlogin')->user()->name}}</a>

                            @else
                            <a href="{{('/user/login')}}" class="header-action-btn login-btn" >Sign In</a>
                        ...
                        @endauth
                            ...
                            <a href="#offcanvas-cart"
                                ...
                                <span class="header-action-num">{{App\Models\cart::where('user_id',Auth::guard('coustomerlogin')->id())->count()}} </span>
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    <li>
                        <a href="single-product.html" class="image"><img src="fronted_assets/images/product-image/1.jpg"
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="fronted_assets/images/product-image/2.jpg"
                                alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="fronted_assets/images/product-image/3.jpg"
                                alt="Cart product Image"></a>
                        <div class="content">
    ...
    <div id="offcanvas-cart" class="offcanvas offcanvas-cart">
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    @foreach ( App\Models\cart::where('user_id',Auth::guard('coustomerlogin')->id())->get() as $cart )
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset('dashboard_assets/uploads/products/preview')}}/{{$cart->rel_to_product->product_photo}}"
                                alt="Cart product Image"></a>
                        <div class="content">
                             <a href="single-product.html" class="title"{{$cart->rel_to_product->product_name}}</a>
                             <span class="quantity-price">1 x <span class="amount">{{$cart->rel_to_product->discount_price}}</span></span>
    ...
    <script src="{{asset('fronted_assets/js/vendor/vendor.min.js')}}"></script>
    <script src="{{asset('fronted_assets/js/plugins/plugins.min.js')}}"></script>
